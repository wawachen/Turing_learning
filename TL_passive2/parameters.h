...
using namespace std;
//********************COEA constants*************
#define CLASSIFIER_GENESIZE          102        //CF_input_n * CF_hidden_n + CF_hidden_n * CF_hidden_n + (CF_hidden_n + 1) * CF_output_n
...
const unsigned CF_input_n = 4;                     //including bias,sensor reading,movement;
