...
void AgentBehaviour(const int &C_num,TestWorld world,Agent* a);//,TestWorld world,Agent* a
void ReplicaBehaviour(const int &C_num,double modelValue[2],TestWorld1 world,Agent1* r);//,TestWorld world,Agent1* r
