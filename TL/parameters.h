...
using namespace std;
//********************COEA constants*************
#define CLASSIFIER_GENESIZE          176            //CF_input_n * CF_hidden_n + CF_hidden_n * CF_hidden_n + (CF_hidden_n + 1) * CF_output_n
#define CLASSIFIER_SELECTIONSIZE     50            //(mu+lmbuda):50+50
#define MODEL_GENESIZE               32             //the same structure as the animal
#define MODEL_SELECTIONSIZE          50            //(mu+lmbuda):50+50
#define MAX_GENERATION               1000        //maximum generations
...
const unsigned CF_input_n = 9;                     //including bias;
